...
urlpatterns = [
    ...
    path('editeaza_recenzie/<pk>', RecenzieUpdateView.as_view(), name='editeaza_recenzie'),
    path('sterge_recenzie/<pk>', RecenzieDeleteView.as_view(), name='sterge_recenzie'),
    path('recenzii/<tur_id>', afiseaza_recenzii, name='afiseaza_recenzii'),
    #
